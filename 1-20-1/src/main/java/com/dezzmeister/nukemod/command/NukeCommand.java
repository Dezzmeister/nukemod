...
public class NukeCommand {
	...
	private static final int nuke(final CommandContext<CommandSourceStack> context, final float blastPower, final boolean causesFire) {
		...
		try {
			...
			final BigExplosion explosion = new BigExplosion(world, null, null, null, pos.x, pos.y, pos.z, radius, causesFire, Explosion.BlockInteraction.DESTROY, blastPower, false);
